    ...
    <body>
                    ...
                    <?php
						...
						if(mysqli_num_rows($resultado) > 0){ // mysqli_num_rows verifica qts registros encontrou através do comando sql
							...
							while($linha = mysqli_fetch_assoc($resultado)){ // percorre o resultado da busca e exibe os dados
                                ...
                                echo "<td width=\"5%\"><a href=\"excluirLivro.php?id=".$linha["idl"]."\">Excluir</a></td>";
                                echo "<td width=\"5%\"><a href=\"alterar.php?id=".$linha["idl"]."\">Alterar</a></td>";
								echo "</tr>";
							}
							echo "</table>";
						}
        ...
        <!--Ir para Menu Inicio-->
                        <div class="col-12" id="link-container">
                            <a href="../html/MenuFuncionario.html">Voltar</a>
                        </div>
        <!--Ir para Menu Fim-->
            </div>
        </div>
